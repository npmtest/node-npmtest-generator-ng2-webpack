...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-generator-ng2-webpack/node_modules/generator-ng2-webpack/libs/mixinFile.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-generator-ng2-webpack/node_modules/generator-ng2-webpack/libs/mixinFile.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-generator-ng2-webpack/node_modules/generator-ng2-webpack/libs/</a> &#187; mixinFile.js</div>
</div>
<div class="body">
...
var readTextFile = function(filename, dirname) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (dirname &amp;&amp; !path.isAbsolute(filename)) {
 ...
 */
var createDirSync = <span class="fstat-no" title="function not covered" >function(path) {</span>
<span class="cstat-no" title="statement not covered" >    mkdirp.sync(path);</span>
};
&nbsp;
/**
 ...
 */
var fileExistsSync = <span class="fstat-no" title="function not covered" >function(file) {</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        fs.accessSync(file);</span>
